...
<section id="education" class="py-16 md:py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <!-- Card Header -->
            <div class="bg-[#535e16] px-6 py-4">
                <h3 class="text-white text-lg font-semibold">Curriculum Program</h3>
            </div>
            <!-- Card Content -->
            <div class="px-6 py-6 bg-white border border-t-0 border-[#535e16]">
                <img src="{{ asset('assets/images/curriculum.png') }}" alt="Curriculum Image" class="w-full rounded-lg shadow-md">
            </div>
        </div>
        <!-- Curriculum LMS Access Section -->
        <div class="mt-16 bg-gradient-to-r from-[#f2c905] to-[#10311e] py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center text-white mb-6">
                <h3 class="text-xl font-semibold">Access our curriculum through the LMS platform below.</h3>
            </div>
            <!-- LMS Link Bar -->
            <div class="flex justify-center">
                <a href="https://sre-hireidn.com" target="_blank"
                class="flex items-center w-full max-w-md bg-white border border-black rounded-md px-4 py-2 shadow-md transition hover:shadow-lg focus:outline-none">    
