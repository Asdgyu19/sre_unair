...
<body class="antialiased bg-white">
    ...
    <section class="bg-blue-100 relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="text-center md:text-left">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                        Energy better <br>for future
                    </h1>
                    <div class="mt-10 flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="#about" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition duration-150 ease-in-out shadow-lg">
                            Discover now
                ...
                <div class="grid grid-cols-2 gap-8">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">Taking care of earth</h3>
                        <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod</p>
                    </div>
                    <div class="text-center">
                        <div class="flex justify-center mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900">Reduce pollution</h3>
                        <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod</p>
                    </div>
                </div>
            </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 z-0">
            <img src="{{ asset('assets/images/solar-panels.jpg') }}" alt="Solar Panels" class="w-full h-auto object-cover opacity-20">
        </div>
    </section>

    <!-- Social Media Links (Matching the reference image) -->
