...
<head>
    ...
    <title>{{ config('app.name', 'SRE UNAIR') }}</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <h3 class="text-lg font-semibold text-gray-800">Society of Renewable Energy</h3>
                        <p class="text-sm text-gray-600">Universitas Airlangga</p>
                    </div>
