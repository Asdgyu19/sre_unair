<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        <span class="text-xl font-bold text-gray-800">SRE UNAIR</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.merchandise.index')" :active="request()->routeIs('admin.merchandise.*')">
                        {{ __('Merchandise') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.merchandise.index')" :active="request()->routeIs('admin.merchandise.*')">
                {{ __('Merchandise') }}
            </x-responsive-nav-link>
