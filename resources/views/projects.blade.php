            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <a href="#" class="text-[#0E9671] hover:text-[#5cb59d] font-medium flex items-center">
                            Learn More
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        <div
                            class="inline-block px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm font-semibold mb-3">
                            Bioenergy
                        </div>
