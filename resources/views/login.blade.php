    ...
    <div class="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Welcome back to SRE Unair</h2>
                <p class="text-gray-600">Powering a sustainable future</p>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20">
                ...
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        ...
                        {{-- Menampilkan error validasi umum di bawah email --}}
                        @error('email')
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm text-primary hover:text-opacity-80 font-medium">
                            Forgot password?
                        </a>
                    </div>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="{{ route('register.form') }}"
                                class="font-medium text-secondary hover:text-opacity-90">
                                Register here
                            </a>
                        </p>
                    </div>
